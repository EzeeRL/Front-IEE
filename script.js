...
form.addEventListener("submit", async (e) => {
  ...
  try {
    const response = await fetch("https://bakend-iie.vercel.app/api/contacto/19", {
      method: "POST",
      headers: {
  ...
  window.location.href = "https://inteligenciaemocionalinstituto.com/vs/vsl.html";
}
    if (response.ok) {
      window.location.href = "https://inteligenciaemocionalinstituto.com/vs/vsl.html"; // ← Cambiá esto por tu URL real
    } else {
